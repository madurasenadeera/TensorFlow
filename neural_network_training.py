...
# Description: Developing a network similar to that demonstrated in operations_network.png     #
#              file. Explored the use of non-linear filters to assist with optimising the      #
#              system as well as performing the training.                                      #
#                                                                                              #
################################################################################################
